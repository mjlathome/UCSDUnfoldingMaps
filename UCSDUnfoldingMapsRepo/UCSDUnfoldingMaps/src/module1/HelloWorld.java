...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		// Assignment 1 - Task 2 - change background colour
		// was: this.background(200, 200, 200);
		this.background(0, 255, 0);
		
		// Assignment 1 - Bonus Task 2 - use gradient fill
		noStroke();
		colorMode(RGB, 800);
		for (int i = 0; i < 800; i++) {
		  for (int j = 0; j < 600; j++) {
		...
		// Assignment 1 - Task 1 - add new map provider
		GoogleMapProvider provider2 = new Google.GoogleMapProvider();
		...
		if (offline) {
			...
			// Assignment 1 - Task 1 - add provider for map2
		...
		// Assignment 1 - Task 1 - add a new map
	    ...
	    // Assignment 1 - Task 1 - map home town
	    map2.zoomAndPanTo(zoomLevel, new Location(43.5f, -80.0f));
		
		// This line makes the map interactive
		MapUtils.createDefaultEventDispatcher(this, map1);
		
		// Assignment 1 - Task 1 - map2 event handling
